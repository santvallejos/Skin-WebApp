            ...
            <AboutUs />
                ...
                <section id="#ComoComprar" className="body-font bg-[#f2ebd9] rounded-t-3xl">
                    <div className="container px-5 pt-3 pb-12 mx-auto">
                        <h1 className="sm:text-3xl text-4xl title-font text-center mb-20 font-bold">¿Como Comprar?
                        </h1>
                        ...
                        <div className="flex flex-wrap sm:-m-4 -mx-4 -mb-10 -mt-4 md:space-y-0 space-y-6">
                            <div className="p-4 md:w-1/3 flex">
                                ...
                                <div className="flex-grow pl-6">
                                    <h2 className=" text-lg title-font font-medium mb-2">Elige tus productos</h2>
                            ...
                            <div className="p-4 md:w-1/3 flex">
                                ...
                                <div className="flex-grow pl-6">
                                    <h2 className=" text-lg title-font font-medium mb-2">Agrega al Carrito</h2>
                            ...
                            <div className="p-4 md:w-1/3 flex">
                                ...
                                <div className="flex-grow pl-6">
                                    <h2 className=" text-lg title-font font-medium mb-2">Finaliza por WhatsApp</h2>
