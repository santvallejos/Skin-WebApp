                    ...
                    <div className="flex flex-col lg:flex-row gap-8 items-center">
                        ...
                        <div className="w-full lg:w-1/2">
                            <BlurFade delay={0.3} inView>
                                <h2 className="text-5xl font-bold mb-6 text-black text-end text-shadow-lg">¿Quiénes Somos?</h2>
                                <div className="space-y-4">
                                    <p className="text-2xl text-black text-end">
                                        <span className="text-[#d41e2b] font-medium text-shadow-lg">Skin</span> nace de una idea clara: darle un estilo propio a tus dispositivos.
                                    </p>
                                    <p className="text-2xl text-black text-end">
